...
{
    /// <summary>
    /// Rules which allow to spend MaxActionPoints.
    /// MoveAction cost 1 point. ItemAction cost 1 point.
    /// MoveAction is restricted after ItemAction is completed
    /// </summary>
    [CreateAssetMenu(menuName = ScriptablePath.Level.ActionRules.ActionPointsCustom)]
    public class ActionPointsCustom : ActionRules
    {
